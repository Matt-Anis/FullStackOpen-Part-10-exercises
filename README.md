...
![QR code](./rate-repository-app/qr-code.svg)

> **Note:** Some users may encounter issues opening the app via Expo Go on a physical device (`java.io.IOException: Failed to download remote update`). If this happens, the app works correctly through an Android/iOS emulator.
